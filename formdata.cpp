...
QString FormData::otkNam()
{
    return ui->comboBoxOtk->currentText();
}

QString FormData::gost()
{
    QString s;
...
QString FormData::description()
{
    return ui->plainTextEdit->toPlainText();
}

QString FormData::upkNum()
{
    return ui->lineEditUpk->text();
}

QString FormData::adr()
{
    return strAdr;
}

QString FormData::kvoSpool()
{
    return ui->lineEditKvoSpool->text();
}

QString FormData::master()
{
...
QString FormData::getNum(QComboBox *c)
{
    int n=0;
